...
Hypothesis: 1: If the 10-day simple moving average (short SMA) of a
            security is higher than its 30-day simple moving average (long SMA),
            the price of the security will drop.
            Conversely, if its short SMA is lower than its long SMA,
            the price will go up. This is referred to as mean reversion.

            2: the greater the relative difference between a security's
            10-day and 30-day SMA, the more likely it is to revert.
...
def compute_weights(context, data):
    ...
    # Normalize our weights, ensure they add up to 100%
    ...
    # Return our normalized_weights. These will be used when placing orders later.
