...
class CSP:
    ...
    """
    # initialize with constraints and variables
    ...
    def solve(self,
        ...
        while len(agenda) > 0:
            ...
            # NOTE: constraint_checker failed
            # NOTE: here use different checker function, basic_constraint_checker,
            #       forward_checking, forward_checking_prop_singleton
            # checking function check curtain state
            ...
            # NOTE: not failed, not solution, then continue
